...
import { View, StyleSheet, Image, Text, TouchableHighlight, Button } from "react-native";
import AppText from '../components/AppText';
function Card({ title, image, subtitle, price, onPress, handleWishlist, handleCart }) {
    return (
        <TouchableHighlight onPress={onPress} underlayColor='lightgrey' style={styles.card} >
            <View>
